...
const restaurants = [
  {
    ...
    image:
      "https://resize.indiatvnews.com/en/resize/newbucket/1200_-/2020/07/barbeque-nation-1594710068.jpg",
    ...
    cuisineNames: [
      ...
      },
      {
        ...
        cost: 85,
        imageLink:
          "https://images.lifestyleasia.com/wp-content/uploads/sites/7/2022/02/01171837/Untitled-design-2.jpg",
      },
      {
        id: 3,
        name: "Grill Sandwich",
        cost: 50,
        imageLink:
          "http://www.yummyfoodrecipes.in/resources/picture/org/Cheese-Grilled-Sandwich-Rec.jpg",
      },
    ],
  },
  {
    ...
    image:
      "https://www.crazymasalafood.com/wp-content/images/2021/12/Hotel-Highway-King.jpg",
  ...
  },
  {
    ...
    image:
      "https://cdn.usarestaurants.info/assets/uploads/89f2af83d08fc9e3bee465ff94d2b86d_-united-states-new-jersey-hudson-county-jersey-city-masala-cafe-chettinad-201-360-3367htm.jpg",
  ...
  },
  {
    ...
    image:
      "https://media-cdn.tripadvisor.com/media/photo-s/18/ec/b7/ac/pool.jpg",
  ...
  },
  {
    ...
    image:
      "https://pix10.agoda.net/hotelImages/2191714/-1/b8debc51b264d33ceee8eb58d7d84511.jpg?ca=7&ce=1&s=1024x768",
    address: "#32 Koramangala street blr",
    contact: 91859656965,
    cuisineNames: [
        {
  ...
  },
  {
    ...
    image:
      "https://im1.dineout.co.in/images/uploads/restaurant/sharpen/2/i/e/p28145-15405415745bd2cc867940c.jpg?tr=tr:n-xlarge",
  ...
  },
  {
    ...
    overview: "Gives dnr,lnc,brf in blr, chn, vnr",
    image:
      "https://images.moneycontrol.com/static-mcnews/2018/07/Starbucks-final-770x433.png",
    address: "#756 ABC STreet , Chennai",
    contact: 91833333365,
    cuisineNames: [
        {
  ...
  },
  {
    ...
    overview: "Gives dnr,lnc,brf in blr, chn, vnr",
    image:
      "https://phrconsultant.in/home/wp-content/uploads/2022/07/WhatsApp-Image-2022-07-05-at-10.34.03-AM-1-1024x577.jpeg",
    address: "#756 ABC STreet , Chennai",
    contact: 91877644965,
    cuisineNames: [
        {
  ...
  },
  {
    ...
    overview: "Gives dnr,lnc,brf in blr, chn, vnr",
    image:
      "https://b.zmtcdn.com/data/pictures/2/20181432/2cd079d2e03f14e6f54517952354ad40.jpeg",
    address: "#756 ABC STreet , Chennai",
    contact: 91857777965,
    cuisineNames: [
        {
  ...
  },
  {
    ...
    overview: "Gives dnr,lnc,brf in blr, chn, vnr",
    image:
      "https://www.creativetourist.com/app/uploads/2016/08/Fab-Cafe-Manchester-1-785x486.jpg",
    address: "#756 ABC STreet , Chennai",
    contact: 91857777965,
    cuisineNames: [
        {
...
const quickRestaurantFilters = [
  {
    ...
    code: timings.BRF,
    image:
      "https://edurekawebbucket.s3.ap-south-1.amazonaws.com/img/breakfast.jpg",
  ...
  },
  {
    ...
    code: timings.DNR,
    image:
      "https://edurekawebbucket.s3.ap-south-1.amazonaws.com/img/dinner.jpg",
    description: "Start Your day with exclusive breakfast options",
  },
  {
    timing: "Snacks",
    code: timings.SKS,
    image:
      "https://edurekawebbucket.s3.ap-south-1.amazonaws.com/img/snacks.jpeg",
    description: "Start Your day with exclusive breakfast options",
  },
  {
    timing: "Night",
    code: timings.NGT,
    image:
      "https://edurekawebbucket.s3.ap-south-1.amazonaws.com/img/nightlife.jpg",
    description: "Start Your day with exclusive breakfast options",
  },
  {
    timing: "Drinks",
    code: timings.DRK,
    image:
      "https://edurekawebbucket.s3.ap-south-1.amazonaws.com/img/drinks.jpg",
    description: "Start Your day with exclusive breakfast options",
  },
];
...
app.get("/getFood", async (req, res) => {
  try {
    ...
    const totalRecord = await (
      await db.collection("food").find({}).toArray()
    ).length;
...
app.get("/getRestaurants", async (req, res) => {
  ...
  filtered_restaurant = restaurants.filter((restaurant) => {
    return Object.keys(filters).every((filter) => {
      return restaurant[filter].some((item, index) =>
      ...
      if (result) {
        ...
        const tokenSignature = {
          ...
          authorizationDetails: {
            routes: ["restaurantList", "addRestaurant", "addFilters"],
          },
        };
        const token = jwt.sign(tokenSignature, "secret", { expiresIn: "1h" });
